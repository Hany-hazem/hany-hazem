...
<p><strong> 🧠 Training Neural Nets & Vibing </strong></p>
...
![tools_I_use](https://img.shields.io/badge/-%F0%9F%9A%80%20AI%20Stack-orange)
...
![tools_I_use](https://img.shields.io/badge/-%F0%9F%9B%A0%EF%B8%8F%20Dev%20Tools-orange)
![semicolon](https://img.shields.io/badge/-%3A-orange)
...
```python
# 🤖 Current State: Evolving into AI Engineering

class Hany(AI_Engineer): 
  def __init__(self):
    self.current_focus  = "Deep Learning & NLP"
    self.active_project = "Titan V2 (600M Param Transformer)"
    self.architecture   = ["Decoder-Only", "Multi-Head Attention"]
